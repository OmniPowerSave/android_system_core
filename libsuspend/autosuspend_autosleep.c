...
static int autosuspend_autosleep_enable(void)
{
    ...
    ALOGV("autosuspend: autosuspend_autosleep_enable\n");
    ...
    ALOGV("autosuspend: autosuspend_autosleep_enable done\n");
...
static int autosuspend_autosleep_disable(void)
{
    ...
    ALOGV("autosuspend: autosuspend_autosleep_disable\n");
    ...
    ALOGV("autosuspend: autosuspend_autosleep_disable done\n");
...
struct autosuspend_ops *autosuspend_autosleep_init(void)
{
    ...
    ALOGI("autosuspend: Selected autosleep\n");
